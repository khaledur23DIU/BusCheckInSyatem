@extends('layouts.app', ['activePage' => 'ticketPrice', 'titlePage' => __('Ticket Price Management')])
...
@section('content')
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-4">
        <form id="ticketPriceValidation" action="{{ route('ticketPrice.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card ">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-9">
                <select class="selectpicker bus_route @error('bus_route') is-invalid @enderror" id="bus_route" name="bus_route" data-style="select-with-transition" title="{{__('Bus Route')}}" required="true">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <input type="number" number="true" min="1" class="form-control @error('price') is-invalid @enderror" placeholder="e.g. 50" id="price" name="price" required="true">
                    @error('price')
                    <label class="error">{{ __($message) }}</label> 
                    @enderror
                  </div>
