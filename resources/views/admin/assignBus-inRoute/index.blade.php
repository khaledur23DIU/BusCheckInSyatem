@extends('layouts.app', ['activePage' => 'busInRoute', 'titlePage' => __('Bus In Route Management')])
...
@section('content')
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-4">
        <form id="busesInRouteValidation" action="{{ route('busInRoute.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card ">
