@extends('layouts.app', ['activePage' => 'checkers', 'titlePage' => __('User Management')])
...
@section('content')
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-5">
        <form id="checkerValidation" action="{{ route('checkers.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card ">
...
@push('js')
  <script>
    $(document).ready(function() {
        setFormValidation('#checkerValidation');
      });
  </script>
