@extends('layouts.app', ['activePage' => 'editRoles', 'titlePage' => __('Roles And Permissions')])
...
@section('content')
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-5">
        <form id="roleValidation" action="{{ route('roles.update',$role->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="card ">
            ...
            <div class="card-body ">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" maxLength="20" id="name" name="name" value="{{$role->name}}" required="true">
                @error('name')
                  ...
                  <tbody >
                    ...
                    <tr>
                      ...
                      @if ($module.'-create' == $permission->name)
                        <label>
                          <input class="@error('permissions') is-invalid @enderror" type="checkbox" @foreach ($rolePermissions as $rolePermission)
            ...
            <div class="card-footer ml-auto mr">
              ...
              <a href="{{ route('roles.index') }}" class="btn btn-rose">{{__('Cancel')}}</a>
            </div>
          </div>
        </form>
      </div>
